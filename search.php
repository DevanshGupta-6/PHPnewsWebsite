  ...
  <head>
    ...
    <?php
          ...
          if(!is_null($db_connection)){
            $statement = $db_connection->prepare("SELECT * FROM articles WHERE title LIKE '%$search%' ORDER BY Date DESC");
            $statement->execute();
    ...
    >
      ...
      <section id="home">
        ...
        <div class="container border">
          <h2 style = "font-size: 300%; text-decoration: underline;">Search Results</h2>
          <!-- Yaha se saari news -->
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header">
                <h3><img src = "./images/<?= $article->cover?>" style = "margin:2rem; border: 0.25rem solid #000000;"><a href = "article.php?id=<?= $article->id?>" class = "title"><?= $article->title ?></a></h3>
